...
同日新增 MINT 倾听与合作、Kristin Neff 自我关怀、WHO 价值与善意三张卡，合计十张。核对范围为相应官方或作者网页的相关说明；没有宣称通读或纳入整套课程。来源、候选 rubric/语料的取舍、两档写作参考与人工评分标准见 [回信 rubric](REPLY-RUBRIC.md)。

三个 NHS 方法卡仅供“一起想办法”检索；一般支持与新增温柔倾听卡可用于两档。“先听我说”不开放练习工具。两份项目原创写作参考每轮随档位装入系统上下文，不需要额外模型调用，也不冒充本轮工具检索结果。私人需求文档仅用于理解产品风格，没有纳入公开仓库或运行时语料。
